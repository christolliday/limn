...
mod test {
    ...
    impl TestWidget {
        fn new(id_gen: &mut IdGen, widget_map: &mut HashMap<LayoutId, LayoutVars>) -> Self {
    ...
    fn get_layout(solver: &mut LimnSolver, widget_map: &HashMap<LayoutId, LayoutVars>) -> HashMap<LayoutId, Rect> {
