...
fn main() {
    ...
    h_align_button.layout.align_top(&root_widget.layout.vars, Some(20.0));
    h_align_button.layout.align_left(&root_widget.layout.vars, Some(20.0));
    v_align_button.layout.align_top(&root_widget.layout.vars, Some(20.0));
    v_align_button.layout.align_right(&root_widget.layout.vars, Some(20.0));

    edit_text_box.layout.below(&h_align_button.layout.vars, Some(20.0));
    edit_text_box.layout.align_bottom(&root_widget.layout.vars, Some(20.0));
    edit_text_box.layout.align_left(&root_widget.layout.vars, Some(20.0));
    edit_text_box.layout.align_right(&root_widget.layout.vars, Some(20.0));
